...
class VideoPlayer(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.inference_btn = QtWidgets.QPushButton("🔮 Run YOLO Detection..."); self.load_video_btn, self.load_csv_btn = QtWidgets.QPushButton("🎬 Load Video"), QtWidgets.QPushButton("📄 Load Detections")
        ...
        processing_toolbar.addWidget(self.inference_btn); processing_toolbar.addWidget(self.batch_process_btn);processing_toolbar.addWidget(self.frame_extractor_btn);processing_toolbar.addWidget(self.video_splitter_btn); processing_toolbar.addStretch(); 
        ...
        processing_layout.addWidget(QtWidgets.QLabel("Max Objects:")); processing_layout.addWidget(self.max_animals_spinbox); processing_layout.addWidget(self.apply_filter_btn)
    ...
    def setup_connections(self):
        self.inference_btn.clicked.connect(self.open_yolo_dialog); self.batch_process_btn.clicked.connect(self.open_batch_dialog)
    ...
    def _update_button_states(self):
        ...
        self.load_video_btn.setEnabled(not is_processing); self.load_csv_btn.setEnabled(not is_processing); self.batch_process_btn.setEnabled(not is_processing); self.inference_btn.setEnabled(not is_processing)
